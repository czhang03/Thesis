...
Our completeness proof for TopKAT relies heavily on a technique called \emph{reduction},
...
Guarded Kleene Algebra with Tests~\cite{Smolka_Foster_Hsu_Kappé_Kozen_Silva_2020} provides a robust equational system that is not only sound and complete with respect to trace equivalence, but also enjoys an efficient decision procedure. 
