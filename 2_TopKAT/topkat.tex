...
\begin{figure}
    ...
    \end{mathpar}
    \caption{Propositional incorrectness logic proof rules~\cite{OHearn_2020}}\label{fig: orignal proof rules of inc logic}
\end{figure}
...
\begin{definition}[Kleene Algebra with Top and Tests]
  ...
  The class of all relational TopKAT is denoted \(\TopREL\).
\end{definition}
...
Finally, following from the completeness with respect to language TopKAT, we will derive the (co)domain completeness of TopKAT, asserting that all TopKAT inequalities that encode (co)domain comparisons are derivable, just using the theory of TopKAT.
