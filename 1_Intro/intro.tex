...
This phenomenon is explained by an efficient fragment of KAT named \emph{Guarded Kleene Algebra with Tests} (GKAT)~\cite{Smolka_Foster_Hsu_Kappé_Kozen_Silva_2020}. Concretely, the fragment of GKAT enjoys a more efficient automaton structure, which enables faster equivalence checking.
...
This inspired our development of TopKAT, which extends KAT by requiring a largest element. 
