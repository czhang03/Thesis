...
TopKAT was able to sound and completely encode propositional incorrectness logic~\cite{O’Hearn_2020},
...
we showed that the reduction from TopKAT to KAT satisfy nice properties that allows 
